...
ENV DUO_CLOUD_IKEY= DUO_CLOUD_SKEY= DUO_CLOUD_SKEY_FILE= \
  DUO_CLOUD_API_HOST= SERVICE_ACCOUNT_PASSWORD= \
  SERVICE_ACCOUNT_PASSWORD_FILE= SERVICE_ACCOUNT_USERNAME=
